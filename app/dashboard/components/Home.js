  ...
  return (
    <div className="rounded-md mt-10 ml-2 lg:ml-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-5 lg:px-0 justify-around gap-2 pb-5">
        ...
        <div className="border md:col-span-2 lg:col-span-1 rounded-md shadow px-20 py-16 bg-gradient-to-r from-blue-500 to-purple-500 text-white flex items-center transition-all duration-300 hover:shadow-lg">
          <div className="mr-3 text-2xl bg-[#FFFF] rounded-full text-black p-3">
            <GiShoppingBag />
          </div>
          <div>
