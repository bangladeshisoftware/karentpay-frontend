...
function Transactions() {
  ...
  return (
    <div className="  h-full relative">
      ...
      <div className="lg:px-0 px-1 h-full">
        <section className=" shadow-md border rounded-md ml-0  mb-36 h-full">
          <div className=" max-w-screen-xl h-full">
            {/* <!-- Start coding here --> */}
            <div className="bg-white h-full dark:bg-gray-800  shadow-md sm:rounded-lg overflow-hidden">
