...
const PricingCard = () => {
  return (
    <div className='border shadow-md rounded-md w-full transition-transform duration-300 hover:scale-105 hover:shadow-lg'>
      <div className='bg-gradient-to-r from-blue-600  to-purple-400 rounded-md py-2 '>
        <div className='border rounded-full flex justify-center mx-auto text-white mt-2 mb-2 w-32'>
          <div className='mt-1 ml-1'>
            <CiBookmarkCheck />
          </div>
          <div className='ml-1'>Popular</div>
        </div>
        <div>
          <h1 className='text-xl text-center text-white pb-2 font-bold'>
            E-Payment GateWay Education
          </h1>
        </div>
        <div>
